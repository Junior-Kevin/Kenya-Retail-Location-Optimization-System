...
KENYA_COUNTY_TOWNS = {
    "Nairobi": [
        ...
        "Lang'ata", "Karen", "Runda", "Lavington", "Parklands"
    ],
    "Mombasa": [
        "Mvita", "Nyali", "Bamburi", "Likoni",
        "Changamwe", "Kisauni", "Shanzu"
    ],
    "Kisumu": [
        "Kisumu CBD", "Milimani", "Manyatta",
        "Nyamasaria", "Nyalenda", "Kondele"
    ],
    "Nakuru": [
        "Nakuru CBD", "Naivasha", "Gilgil",
        "Molo", "Njoro", "Bahati"
    ],
    "Kiambu": [
        "Thika", "Ruiru", "Juja",
        "Kiambu Town", "Githurai", "Limuru"
    ],
    "Uasin Gishu": [
        "Eldoret CBD", "Turbo", "Burnt Forest",
        "Ziwa", "Moiben"
    ],
    "Meru": [
        "Meru Town", "Nkubu", "Timau",
        "Maua", "Laare"
    ],
    "Machakos": [
        "Machakos Town", "Athi River",
        "Kangundo", "Mwala", "Masinga"
    ],
    "Kakamega": [
        "Kakamega Town", "Mumias",
        "Malava", "Butere", "Shinyalu"
    ],
    "Bungoma": [
        "Bungoma Town", "Webuye",
        "Kimilili", "Chwele", "Sirisia"
    ],
    "Kisii": [
        "Kisii Town", "Ogembo",
        "Suneka", "Mosocho"
